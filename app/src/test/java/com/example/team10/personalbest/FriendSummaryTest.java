...
public class FriendSummaryTest {

    HomePage homePage;
    FriendSummary friendSummary;
    HashMap<String, WalkDay> friend_walkdays;
    String userEmail;
    ...
    public void setup0(){
        ...
        for(int i =0; i< 36; i++){
            ...
            friend_walkdays.put(currentDay.toString(), currentWalkDay);
            currentDay = currentDay.minusDays(1);
        }

        ActivityMediator.setFriendWalkDays(friend_walkdays);
        friendSummary = Robolectric.setupActivity(FriendSummary.class);
